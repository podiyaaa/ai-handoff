 ...
 * each independent piece (search input, tree render). Loaded last (after
 * bridge-client.js, virtual-list.js, tree-render.js, search-render.js all
 * define their globals) since it's the one that actually wires them together.
 */
(function () {
  function boot() {
